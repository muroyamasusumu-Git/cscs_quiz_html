...
// 【役割の明示】
// このスクリプトは Bパートにおいて
// 「正解の選択肢 <li> / <a> に is-correct クラスを付与する」
// ことだけを目的とした “クラス付与専用JS” です。
//
// ✔ 表示スタイル（下線・色・アニメーション等）は一切変更しない
// ✔ CSS は定義・注入しない
// ✔ inline style も付与しない
// ✔ 集計・トークン・SYNC・判定ロジックには関与しない
//
// 見た目の制御はすべて CSS / 他スクリプト側に委ね、
// 本ファイルは「正解位置のセマンティクス付与」に専念します。
// ============================================================
